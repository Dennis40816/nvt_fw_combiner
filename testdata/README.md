...
`testdata/golden/ctrlram-replace/` is a private fixture handoff folder for future CtrlRAM Replace byte evidence. It tracks metadata and a manifest template only until owner-approved payloads, write ranges, and production output gates are ready.
