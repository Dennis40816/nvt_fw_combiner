...
public sealed partial class RepositoryBoundaryTests
{
    ...
    public void FirmwareSlotViewModelConcernsStaySplit()
    {
        ...
        Assert.Contains("internal sealed partial class FirmwareSlotViewModel", root, StringComparison.Ordinal);
        ...
        Assert.DoesNotContain("internal sealed record FirmwareSlotFactViewModel", root, StringComparison.Ordinal);
        Assert.DoesNotContain("internal enum FirmwareSlotKind", root, StringComparison.Ordinal);
        ...
        Assert.DoesNotContain("FirmwareSlotKind.Dp", replaceRunner, StringComparison.Ordinal);
        ...
        Assert.Contains("internal sealed record FirmwareSlotFactViewModel", facts, StringComparison.Ordinal);
        Assert.Contains("internal enum FirmwareSlotKind", kind, StringComparison.Ordinal);
    }
}
