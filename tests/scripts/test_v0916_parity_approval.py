...
class V0916ParityApprovalTests(V0916ParityTestBase):
    ...
    def _finalize_fixture(self, root: Path) -> dict[str, object]:
        ...
        protected_run = {
            ...
            "workflowSemanticContractSha256": "2b0df686a5109ad187a7cff5d1cef667cbf1dc72e78f24fb222d244357c8a05d",
            "workflowRun": {
    ...
    def _schema_complete_comparison_fixture(self) -> dict[str, object]:
        ...
        comparison = {
            ...
            "candidateAuthority": {
                ...
                "finalEvidenceTail": plan.raw["candidateAuthority"]["finalEvidenceTail"],
            },
            "baselineExecutor": {
