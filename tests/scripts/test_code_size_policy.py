...
class CodeSizePolicyTests(unittest.TestCase):
    ...
    def test_frozen_release_baseline_emits_no_full_production_warning(self) -> None:
        ...
        self.assertEqual(136_056, snapshot.production_nonblank)
        self.assertEqual(98_226, snapshot.runtime_production_nonblank)
        self.assertEqual(20_632, snapshot.domain_profiles_nonblank)
        self.assertEqual(41_951, snapshot.application_nonblank)
        self.assertEqual(5_039, snapshot.bootstrap_cli_nonblank)
        self.assertEqual(30_604, snapshot.infrastructure_contracts_worker_nonblank)
