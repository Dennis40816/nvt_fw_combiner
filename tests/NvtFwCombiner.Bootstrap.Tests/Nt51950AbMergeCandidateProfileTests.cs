...
public sealed class Nt51950AbMergeCandidateProfileTests
{
    ...
    public void CandidateProfileRejectsNon512KiBMapCapacity()
    {
        ...
        V2CompositionPlanCompileResult compilation = TrustedV2CompositionCompiler.Compile(
            LoadCandidateCatalog(workspace),
            "nt51950-ab-merge",
            "0.1.0",
            "NT51950",
    ...
    private static TrustedProfileBundleCatalog LoadCandidateCatalog(TempWorkspace workspace)
    {
        return AbMergeCandidateBundleTestSupport.LoadCatalog(workspace, BundleDirectory, BundleContentHash);
    }
