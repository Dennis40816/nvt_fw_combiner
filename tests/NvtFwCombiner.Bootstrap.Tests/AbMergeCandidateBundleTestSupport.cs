...
/// <summary>Loads a source AB candidate bundle through the same trusted snapshot path used by candidate tests.</summary>
internal static class AbMergeCandidateBundleTestSupport
{
    internal static TrustedProfileBundleCatalog LoadCatalog(
