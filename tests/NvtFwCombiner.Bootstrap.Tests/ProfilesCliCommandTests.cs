...
public sealed class ProfilesCliCommandTests
{
    ...
    public async Task ProfilesListOutputRemainsStable()
    {
        ...
        [
            ...
            "nt51919-ab-merge-alias  ic=NT51919  inputs=dp-ab-input, tp-a-input, tp-b-input  default-output=nt51919-ab-merge.bin",
            "nt51929-ab-merge  ic=NT51929  inputs=dp-ab-input, tp-a-input, tp-b-input  default-output=nt51929-ab-merge.bin",
            "nt51932-ab-merge  ic=NT51932  inputs=dp-ab-input, tp-a-input, tp-b-input  default-output=nt51932-ab-merge.bin",
