...
public sealed class ProfilesCliCommandTests
{
    ...
    public async Task ProfilesListOutputRemainsStable()
    {
        ...
        [
            ...
            "nt51919-ab-merge-alias  ic=NT51919  inputs=dp-ab-input, tp-a-input, tp-b-input  default-output=NT{ic}_A_{dp-a}{tp-a}_B_{dp-b}{tp-b}_{date}.bin",
            "nt51929-ab-merge  ic=NT51929  inputs=dp-ab-input, tp-a-input, tp-b-input  default-output=NT{ic}_A_{dp-a}{tp-a}_B_{dp-b}{tp-b}_{date}.bin",
            "nt51932-ab-merge  ic=NT51932  inputs=dp-ab-input, tp-a-input, tp-b-input  default-output=NT{ic}_A_{dp-a}{tp-a}_B_{dp-b}{tp-b}_{date}.bin",
            ...
            "nt51920-dp-replace-gen-flash  ic=NT51920  inputs=dp-replacement, reference-base  ic-num=SingleSelector  default-output=nt51920-dp-replace.bin",
            ...
            "nt51930-dp-replace-flashmap  ic=NT51930  inputs=dp-replacement, reference-base  ic-num=SingleSelector  default-output=nt51930-dp-replace.bin",
            "nt51931-dp-replace-gen-flash  ic=NT51931  inputs=dp-replacement, reference-base  ic-num=SingleSelector  default-output=nt51931-dp-replace.bin",
