...
public sealed class ProfilesCliCommandTests
{
    ...
    public async Task ProfilesListOutputRemainsStable()
    {
        ...
        [
            ...
            "nt51928-standard-merge-gen-flash  ic=NT51928  inputs=dp-input, ld-input (optional), tp-input  default-output=nt51928-standard-merge-gen-flash.bin",
            ...
            "nt51928-dp-replace-gen-flash  ic=NT51928  inputs=dp-replacement (optional), ld-replacement (optional), reference-base  ic-num=SingleSelector  default-output=nt51928-dp-replace.bin",
