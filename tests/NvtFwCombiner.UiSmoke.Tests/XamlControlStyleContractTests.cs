...
public sealed partial class XamlControlStyleContractTests
{
    ...
    public void SharedControlStyleLibraryIsIncludedByTheApplication()
    {
        ...
        Assert.DoesNotContain("Styles/MessageCenterStyles.axaml", application, StringComparison.Ordinal);
        Assert.Contains("Styles/MessageCenterStyles.axaml", ReadPresentationFile("Views/MessageCenterModal.axaml"), StringComparison.Ordinal);
