...
public sealed partial class XamlControlStyleContractTests
{
    ...
    public void OutputDeliveryConfirmationUsesOneAccessibleSharedModal()
    {
        ...
        Assert.Contains("x:Name=\"BundleFolderNameDisplay\"", modal, StringComparison.Ordinal);
        Assert.Contains("x:Name=\"ParentDirectoryDisplay\"", modal, StringComparison.Ordinal);
        Assert.DoesNotContain("x:Name=\"BundleEditPanel\"", modal, StringComparison.Ordinal);
        ...
        Assert.Contains("x:Name=\"ChooseParentButton\"", modal, StringComparison.Ordinal);
        Assert.Contains("Classes=\"semanticAction inlineEdit outputNameEdit folderPickerAction\"", modal, StringComparison.Ordinal);
        Assert.Contains("Click=\"ChooseParentButton_OnClick\"", modal, StringComparison.Ordinal);
        Assert.Contains("ToolTip.Tip=\"{Binding Text.OutputDeliveryChooseParentLabel}\"", modal, StringComparison.Ordinal);
        Assert.DoesNotContain("IsReadOnly=\"True\" Text=\"{Binding ParentDirectory}\"", modal, StringComparison.Ordinal);
        ...
        Assert.Contains("ColumnDefinitions=\"*,300\"", modal, StringComparison.Ordinal);
        Assert.Contains("x:Name=\"CtrlRamVersionControlGroup\"", modal, StringComparison.Ordinal);
        Assert.Contains("Width=\"300\"", modal, StringComparison.Ordinal);
