...
| 3 | Settings Version local presentation (13) | [Approved reference and bounded implementation](../ui/v1.1.x-settings-version-handoff.md); source/list cleanup and per-version notes in progress. Preserve typed ownership and transaction/confirmation behavior. |
