...
| P0 | DP Replace production closure | NT51950/NT51951 DP Replace UI/CLI workbench path exists; other IC DP Replace mappings remain gated. | Golden outputs for the 950/951 exact-base/variable-DP rule, and per-IC DP/LD maps for any other released DP Replace IC. |
