...
| P1 | Report/history completeness | Preview/Build report modal exists; first-peak errors, save flow, output artifact path display, and local persistent report history exist. | Finish richer history metadata and visual consistency for normalized ranges, Combiner argv, warnings, gated-state reason, and support-ready audit review. |
