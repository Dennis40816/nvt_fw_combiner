...
| NT51931 | single/cascade | single, cascade | `NT51931BASED_NORMAL_MODE CRC8` | 1 / 1 | Registered Combiner 1.13.0 selected after full-byte equality with the owner 1.2.0.4/51930-based control; Replace remains unavailable only until exact V2 route review. |
