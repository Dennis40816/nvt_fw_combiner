...
```text
All currently classified CtrlRAM self-replacement differences are either known header/CRC drift or explicitly documented exceptions. NT51926 2.0.0 single/cascade, NT51930 INX 1.3.0 cascade 3, and NT51932 2.0.0 cascade 3 exact-case V1/V2 parity are closed without support promotion. Exact-case parity/tool gates for NT51931 and NT51951 remain engineering gates for a blanket CtrlRAM Replace OK claim; none requires additional owner input.
```
