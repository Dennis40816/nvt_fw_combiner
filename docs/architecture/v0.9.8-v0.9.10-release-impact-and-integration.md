...
| `v0.9.10` stable reconciliation | Complete | Version branch `e968a310`; PR `#150` exact-head review found no major issue, all threads are resolved, and required CI is green | Preserve this reviewed tree through the protected-main integration |
...
| `v0.9.10` publication | Version integration complete | `0.9.10` at `e968a310`; VERSION is `0.9.10` | Complete metadata review, protected-main PR/CI, exact-main package/provenance, annotated tag, and GitHub Release |

The stable-predecessor B/C comparison remains fixed at Node B `32c37e25` and
Node C `6f3698dd`. The final integration tree at `e968a310` additionally passed
the owner-approved UAT/safety phases, canonical verifier, exact-head review, and
required feature CI. Protected-main integration, exact-main packaging,
provenance, tag, and GitHub Release remain publication gates.
