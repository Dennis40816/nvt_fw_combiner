...
| `v0.9.10` stable reconciliation | Reopened after complete base | Candidate base `6f3698dd`; 130/130 patches equal, build 0/0, semantic suites and clean structure pass | Review the owner-added post-commit report-delivery contract on the exact new head |
| `v0.9.10` authoritative B/C | Earlier frozen-tree capture complete | B `32c37e25`, C `6f3698dd`; exact hashes/counts/raw samples in the performance baseline | Reconfirm exact-head output/report/command parity; packaged UI/accessibility and human review remain |
...
The stable-predecessor B/C is complete for the earlier frozen tree. Owner scope
reopened on 2026-07-19 for the post-commit background-report delivery boundary,
so exact-head parity and R2 must be rebuilt together with packaged
interaction/accessibility, the single final canonical verifier, required CI,
protected-main merge, tag, and GitHub Release.
