...
| `v0.9.10` reconciled candidate | `c1f07ce5` | 59,429 | 61,580 | 9,891 | +5,801 from `v0.9.9.5` |
...
reconciled, `c1f07ce5` measures 59,429 production lines: three lines above the
...
| `v0.9.10` release checklist | Predecessor reconciliation complete; formal release gates remain | Reconciled candidate `c1f07ce5`, Release build 0 warnings/errors | Complete batch tests, B/C, parity, review, verifier, CI, main merge, tag, and release |
