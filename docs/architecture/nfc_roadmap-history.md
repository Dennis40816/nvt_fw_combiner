...
Status: historical record, not current allocation. The
[NFC Roadmap](nfc_roadmap.md) owns current and future version allocation;
nothing below is an open allocation or release gate.

On 2026-09-26 (task `ROADMAP-HISTORY-1113-01`) these sections moved verbatim
from `nfc_roadmap.md` as of `04369b738` (blob `00baf161e`): the superseded evidence
checkpoint of 2026-09-19 (the roadmap's line 5) and the published-release
sections `0.10.0` through `1.1.5` (its lines 472-1989). One link changed: the
`1.1.5` pointer to the 1.1.12 startup amendment, which stayed in the roadmap,
now names `nfc_roadmap.md`. Words such as "above", "below", "this file" and
"this roadmap" in the moved text refer to the roadmap as of that commit.

## Former evidence checkpoint — 2026-09-19
...
readiness optimization into [1.1.12](nfc_roadmap.md#owner-approved-1112-startup-optimization--2026-09-25).
