...
```mermaid
flowchart TD
    IC["IC definition"] --> Identity["identity, perfect-like membership, and shared-part relationships"]
...
distinct identity/revision concepts.
...
bundle declares IC identity, perfect-like membership or shared-part relationships, maps and IC Count
