...
pending input length or blocked capability remains explicitly pending/blocked;
the UI may show the known physical-map skeleton but must not invent final byte
ownership.
