...
For the detailed owner checklist, sentinel BIN validation method, and 0.7.0 refactor gates, also see
[`0.7.0-refactor-and-evidence-plan.md`](0.7.0-refactor-and-evidence-plan.md). That document is a retained historical checklist for NT51926/NT51930 versioned postbuild categories and for universal special-value BIN validation. Active version allocation and completion status are maintained only in [`NFC Roadmap`](nfc_roadmap.md).
