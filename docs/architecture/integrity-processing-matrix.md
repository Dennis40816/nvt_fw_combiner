...
| NT51932 | uploaded/reference AB combiner | None | Address relocation only; no CRC configured | fixed-`0x80000` V2 candidate relocates little-endian `u32` offsets `0x7164/0x7168/0x716C` by `+0x40000` in a cloned TPB buffer | Direct named Python-configuration synthetic parity: `cd54e124...7de10ce`; direct product golden or owner-approved fact-scoped alias evidence plus firmware-owner promotion review remain pending |
