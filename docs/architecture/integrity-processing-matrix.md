...
| --- | --- | --- | --- | --- |
| CtrlRAM Replace priority flows | post-replace header/integrity stage | legacy `combiner.exe` CRC/header recalculation expected | Combiner 1.13.0 postbuild catalog is implemented for NT51917, NT51919, NT51920, NT51923, NT51926, NT51927, NT51928 non-NB, NT51929, NT51930, NT51931, NT51932, NT51950, and NT51951; NT51926 and NT51930 select postbuild category from base FWConfig Common FW version. Exact owner-backed V1/V2 routes are locked for the released NT51920/23/26/27/29/30/31/32/50/51 cases. NT51917 additionally has owner-approved perfect-family V2 aliases for the three exact NT51927 single/two-/three-chip routes; their bytes, 7/10/13-command argv, authority, report identity, and immutable inputs match while the staged filename remains IC-specific. NT51919 likewise uses an exact-base perfect-family alias of NT51929 with identical V1/V2 output SHA `d23f53a1...198f`, two-command argv, authority, report identity, and immutable inputs. NT51928 non-NB uses only its exact canonical 512 KiB FW 1.3.2/two-chip base with V1/V2 SHA `fbe011c7...f24c`, ten-command parity, and a preserved DP/LDC tail; NB and every other shape remain outside that exact V2 admission and fail closed. NT51950 AUTO_PRJ-676/PID `0x4A06`/FW 2.0.0/single has V1/V2 SHA `a32e6896...d5c4`, zero payload drift, and only four owner-reference CRC-word differences; its short NF tail and oversized Normal warning are verified. For exact admitted NT51926 V2 routes, a Build-only TP FW version edit is applied before postbuild and the final Backup is validated before commit; it remains outside the no-edit parity claims and creates no support promotion. | Exact case parity closed support-neutrally; every unreviewed shape fails closed |
