...
| --- | --- | --- | --- | --- | --- |
| NT51917 | `SM-GENFLASH-ALIAS`: executable owner-confirmed alias of NT51927. | `R-DP-GENERIC`: DP profile wiring pending. | `R-CTRLRAM-927`: follows NT51927, numeric single/2/3 IC and cascade. | `R-GENERAL-POSTBUILD`: explicit mappings use protected-range gates; TP/CtrlRAM mappings run selected postbuild when available. | Standard Merge alias regression uses NT51927 golden bytes; CtrlRAM command core implemented. |
...
Used by the executable golden-backed gen_flash profiles: NT51920, NT51923, NT51926, NT51927, NT51929, NT51931, and NT51932. Bootstrap selects the packaged, hash-anchored V2 artifact for NT51919, NT51920, NT51923, NT51926, NT51929, and NT51932; the remaining profiles use their legacy compiled artifact. Owner-confirmed aliases reuse this same byte flow: NT51917 follows NT51927, and NT51919 is a map-bound alias of NT51929.
