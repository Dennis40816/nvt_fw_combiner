...
| NT51950 | `SM-950-951-DP-PERSPECTIVE-V2`: packaged canonical V2 maps select the exact submitted DP capacity; owner `0x40000` DP golden passes. | `R-DP-950-951`: workbench exact-base path implemented; owner support promotion remains pending. | `R-CTRLRAM-51950`: direct postbuild reference. | `R-GENERAL-POSTBUILD`: explicit mappings use protected-range gates; TP/CtrlRAM mappings run selected postbuild when available. | All three V2 capacities have legacy/V2 parity; only `0x40000` has a direct NT51950 golden. Deferred AB shares only the full-DP-first order, not normal-merge ranges or integrity rules. |
| NT51951 | `SM-950-951-DP-PERSPECTIVE-V2`: packaged canonical V2 maps select the exact submitted DP capacity; owner `0x80000` DP golden passes. | `R-DP-950-951`: follows NT51950 workbench exact-base path; owner support promotion remains pending. | `R-CTRLRAM-51950`: follows NT51950. | `R-GENERAL-POSTBUILD`: explicit mappings use protected-range gates; TP/CtrlRAM mappings run selected postbuild when available. | All three V2 capacities have legacy/V2 parity; only `0x80000` has a direct NT51951 golden. |
