...
Current execution priority: normal Merge and normal Replace for DP and TP CtrlRAM department workflows are pulled forward. AB merge remains in the roadmap but is deferred until the owner reactivates it. NT51950/NT51951 normal Merge waits for owner memory maps; Replace CRC/header waits for owner-supplied `combiner.exe` invocation and golden evidence.
...
| `0.5.0-dev.N` | Normal Replace priority | Display/DP and TP HW CtrlRAM Replace workflows, IC num selection, and post-replace combiner readiness. |
