...
| --- | --- | --- | --- | --- |
| `BuiltInStandardMergeProfiles` | Legacy Standard Merge plan parity and non-golden capacity comparison tests | Direct V2 Standard Merge golden coverage independent of the C# profile oracle for every owner-approved case; retain legacy-only parity until every selected capacity has direct V2 evidence | `v0.9.5` | retain as test baseline: direct cases cover NT51950 `0x40000` and NT51951 `0x80000`; NT51950 `0x80000`/`0x100000` and NT51951 `0x40000`/`0x100000` remain required |
