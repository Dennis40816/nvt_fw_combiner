...
| `BuiltInReplaceProfiles.DpPerspective` | None. NT51950/NT51951 DP Replace runtime, CLI/UI, display, coverage, and golden execution all use V2 registrations | Direct V2 plan contracts across all declared capacities; static deterministic output hashes; archived owner-approved legacy comparison; owner self-replacement controls | `v0.9.5` | retired in `7578de69` (`refactor(dp-replace): retire legacy DP Perspective profiles`); this does not change candidate policy or other Replace workflows |
