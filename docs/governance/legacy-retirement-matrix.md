...
| --- | --- | --- | --- | --- |
| `BuiltInStandardMergeProfiles` | Legacy Standard Merge plan parity and non-golden capacity comparison tests | Direct V2 Standard Merge golden coverage independent of the C# profile oracle for every owner-approved case; retain legacy-only parity until every selected capacity has direct V2 evidence | `v0.9.5` | direct V2 owner-golden complete; retain as test baseline |
