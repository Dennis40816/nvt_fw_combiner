...
| `CompositionProfileCompiler` legacy authority | Residual CtrlRAM and General Replace Workbench adapters. Exact NT51917/NT51919 aliases, NT51928 non-NB partial alias, NT51920, NT51923, NT51926, NT51927, NT51929, NT51930, NT51931, NT51932, NT51950, and NT51951 CtrlRAM shapes plus NT51926 single/full-Flash/file-backed DP-only General Replace now route through trusted V2 executable candidates | All remaining non-exact shapes fail closed, then both production callers are removed | `v0.9.9` | exact routed slices are retired without support promotion; final caller deletion remains |
