...
| --- | --- | --- | --- | --- |
| `BuiltInStandardMergeProfiles` | Standard Merge plan/golden parity tests | Direct V2 Standard Merge golden coverage independent of the C# profile oracle for every retained family | `v0.9.5` | retain as evidence |
