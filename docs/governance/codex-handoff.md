...
9. **Standard Merge parity** — one IC/mode per PR with approved golden evidence.
10. **AB Merge parity** — banks, relocation, integrity stages, output comparisons.
11. **Persona Replace** — Display, TP HW, TP FW compiler policies and UI.
