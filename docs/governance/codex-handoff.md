...
11. **AB Merge parity** — banks, relocation, integrity stages, and output comparisons. Candidate work is active for the `v0.9.3` evidence path, but UI/CLI exposure and support promotion remain gated by per-IC golden, processor, and firmware-owner review.
