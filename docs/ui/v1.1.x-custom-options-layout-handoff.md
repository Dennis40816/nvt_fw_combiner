...
Current owner priority, 2026-09-14: preview the existing CtrlRAM selection-slot
alignment first. Record the Desay decisions now, then return to the public/vendor
...
with the Input files frame is recorded; top-edge alignment versus equal panel
height is being clarified before implementing that additional geometry.
...
owner visual acceptance is received, production implementation is next.
