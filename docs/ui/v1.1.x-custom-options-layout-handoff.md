...
detection with absent display names. The timing of save/apply/reload and the
treatment of an already-running Build remain for the next lifecycle decision;
this approval does not imply hot-swapping rules during execution.
