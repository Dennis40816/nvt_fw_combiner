...
the bundled/repo runtime. Handling an invalid explicit override and the exact
UI preview remain implementation-design questions, not already accepted
behavior. Existing `1.1.8` dependency-fix/release evidence remains separate; no production code or
