...
- `CanonicalDynamicCompilationContract` currently binds one exact profile ID;
  ...
  The precise variant declaration/materialization still needs concrete design
  review before implementation. It must cover profile/map, transport bank
  spans, DIFF delta, processor command and three imported header slices together.
