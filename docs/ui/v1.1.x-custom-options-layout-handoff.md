...
this intake, accepted fallback/trust decisions and preview. The relocation
preserves the existing section link; bundled/default Runtime shipped in 1.1.8,
while user selection remains pending 1.1.9 implementation.
