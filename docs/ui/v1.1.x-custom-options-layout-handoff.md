...
structure and behavior above are approved; exact visual-reference geometry has
not yet been produced or accepted. No production UI/configuration is implemented
