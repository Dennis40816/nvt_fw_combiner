...
Current visual review: [compact categorized Config preview](#compact-categorized-config-preview--2026-09-14).
The owner requests a denser layout and categories for future configuration
growth; the preceding stacked two-table image is retained as iteration history.
