...
- First local unit implements pure Application configuration admission and an
  ...
  and no Common fallback. No settings persistence, UI or AB runtime wiring yet.
...
- Independent `/root/v116_config_architecture` scoped R2 Polytail: **PASS**,
  ...
  evidence. Next unit is the bounded JSON persistence/save/reload lifecycle,
  followed by canonical profile/detection integration and the approved UI.
