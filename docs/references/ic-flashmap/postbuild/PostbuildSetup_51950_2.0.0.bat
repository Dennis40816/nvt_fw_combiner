...
@ECHO ----------------------------------------------------
@ECHO --- NT51950 Search USER_SWITCH_APPLICATION_TYPE
@ECHO ----------------------------------------------------
:Sesrch
set file=..\inc\define\mmap.h

@ECHO ----------------------------------------------------
@ECHO --- NT51950 Parsing FLASH MAP
@ECHO ----------------------------------------------------
...
set fmap_header=FLASHMAP_HEADER_INFO
...
if  not defined header  Goto :ERR
...
@ECHO ----------------------------------------------------
@ECHO --- NT51950: %cascadenum% CHIP(s)
@ECHO ----------------------------------------------------
@python output\InsertSID.py output\nt51950_fw.bin

if %cascadenum% == 2        Goto  :NT51950_Cascade_Postbuild
if %cascadenum% == 1   	    Goto  :NT51950_Single_Postbuild
goto :ERR
...
:NT51950_Cascade_Postbuild
@output\Combiner.exe NT51950BASED_NORMAL_MODE CRC8 output\nt51950_fw.bin output\nt51950_fw.bin %CtrlramCMD% %DiffCtrlramCMD% %VNCtrlramCMD% %NFCtrlramCMD% %HeaderCMD%
@output\Combiner.exe NT51950BASED_NORMAL_MODE CRC8 output\nt51950_fw.bin output\nt51950_fw.bin %HeaderCMD%
exit /b
goto :EOF

:NT51950_Single_Postbuild
@output\Combiner.exe NT51950BASED_NORMAL_MODE CRC8 output\nt51950_fw.bin output\nt51950_fw.bin %CtrlramCMD% %VNCtrlramCMD% %NFCtrlramCMD% %HeaderCMD%
@output\Combiner.exe NT51950BASED_NORMAL_MODE CRC8 output\nt51950_fw.bin output\nt51950_fw.bin %HeaderCMD%
exit /b
goto :EOF
