...
@ECHO ----------------------------------------------------
@ECHO --- NT51932 Search USER_SWITCH_APPLICATION_TYPE
@ECHO ----------------------------------------------------
:Sesrch
set file=..\inc\define\mmap.h

@ECHO ----------------------------------------------------
@ECHO --- NT51932 Parsing FLASH MAP
@ECHO ----------------------------------------------------
...
@ECHO ----------------------------------------------------
@ECHO --- NT51932: %cascadenum% CHIP(s)
@ECHO ----------------------------------------------------
@python output\InsertSID.py output\nt51932_fw.bin

if "%cascadenum%" EQU "1" (
    goto :NT51932_Single_Postbuild 
) else (
    goto :NT51932_Cascade_Postbuild
)
goto :ERR
...
:NT51932_Cascade_Postbuild
@output\Combiner.exe NT51932BASED_NORMAL_MODE CRC8 output\nt51932_fw.bin output\nt51932_fw.bin %CtrlramCMD% %DiffCtrlramCMD% %VNCtrlramCMD% %NFCtrlramCMD% %HeaderCMD%
@output\Combiner.exe NT51932BASED_NORMAL_MODE CRC8 output\nt51932_fw.bin output\nt51932_fw.bin %HeaderCMD%
exit /b
goto :EOF

:NT51932_Single_Postbuild
@output\Combiner.exe NT51932BASED_NORMAL_MODE CRC8 output\nt51932_fw.bin output\nt51932_fw.bin %CtrlramCMD% %VNCtrlramCMD% %NFCtrlramCMD% %HeaderCMD%
@output\Combiner.exe NT51932BASED_NORMAL_MODE CRC8 output\nt51932_fw.bin output\nt51932_fw.bin %HeaderCMD%
exit /b
goto :EOF
