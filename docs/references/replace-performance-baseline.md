...
## Authoritative stable and release-candidate capture

The final stable-predecessor B/C protocol, raw samples, runtime prewarm,
committed-artifact/report boundary, and remaining release record continue in
[v0.9.10 Stable Performance Capture](v0.9.10-stable-performance-capture.md).
