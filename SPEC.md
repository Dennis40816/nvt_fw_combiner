...
> 文件狀態：`1.1.5 support-neutral verification/UI performance candidate; final release gates pending`
> 文件版本：`1.1.5`
> 文件基準日期：`2026-09-10`
...
- Main EXE at or below 70,000,000 bytes is a soft optimization target, and its hard ceiling remains 80,000,000 bytes. Until reviewed package-size reduction is accepted, the complete release ZIP uses the temporary inclusive 134,217,728-byte ceiling from ADR 0060; required safety, profiles, processors, evidence, accessibility, and self-contained runtime content cannot be removed merely to meet a smaller number. Version 1.0.2 is a one-time fresh/manual installation and does not claim managed auto-upgrade from immutable 1.0.0 or 1.0.1.
