...
As of 2026-07-22, `0.9.14` starts from stable `v0.9.13`/`main` commit `f9f8dbcd979ecdef43f432016787e57763819492`. It owns the R3-gated NT51919/NT51929/NT51932 AB pilot, typed input diagnostics, the minimum AB authoring surface, IC detail disclosure, targeted UI correctness fixes, smarter canonical toolchain entry, GitHub Actions cost control, and CI-owned stable release promotion. The 2026-07-23 owner rescope assigns `0.9.15`, from official `v0.9.14`, to AB delivery readiness and review automation; reserves `0.9.16` for NT51950 and `0.9.17` for independent NT51951 candidate closure. Cross-workflow header/status and Memory coverage unification, the shared Hex viewport/Changes redesign, and global Button pressed feedback remain deferred to a later owner-selected milestone; NT51950/NT51951 AB admission remains separately evidence-gated.
