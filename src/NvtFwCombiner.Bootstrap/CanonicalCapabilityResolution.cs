...
/// <summary>
/// Resolves and binds canonical capabilities while the legacy registration
/// compiler remains present. It owns no workflow execution or presentation.
/// </summary>
internal static partial class CanonicalCapabilityResolution
{
    ...
    internal static CapabilityResolutionResult ResolveCanonicalDpReplaceCapability(
        string icId,
        long outputCapacity)
    {
        return WorkbenchHostServices.CanonicalCapabilities.Read(
    ...
    internal static bool TryCompilePublishedStandardMergeCapability(
        string icId,
        long? outputCapacity,
    ...
    internal static bool TryCompilePublishedDpReplaceCapability(
        string icId,
        long baseCapacity,
        out CompiledComposition? composition,
        out ResolvedCapability? resolvedCapability,
    ...
    internal static bool TryCompilePublishedDynamicCapability(
        string icId,
        string workflowId,
