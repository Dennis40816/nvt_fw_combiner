        ...
        [
            .. context.SelectedSources
                ...
                .Select((entry, index) =>
                {
                    ...
                    CompositionMemoryProjection.CtrlRamSlotId(entry.Source.SourceId),
        ...
        V2RuntimeReferenceReplacePostbuildPolicy? postbuildPolicy =
            diffDlmPolicy is null
                ...
                : new V2RuntimeReferenceReplacePostbuildPolicy(
                    ...
                    diffDlmSource is null ? null : CompositionMemoryProjection.CtrlRamSlotId(diffDlmSource.SourceId),
