...
public static partial class WorkbenchCompositionService
{
            ...
            WorkbenchCtrlRamFirmwareVersionEdit? firmwareVersionEdit)
    {
        ...
        InputArtifactBinding[] acceptedBindings = CreateCtrlRamReplaceBindings(
        ...
        {
            byte[]? bytes = TryReadFirmwareImage(binding.ArtifactId);
            if (bytes is null ||
    ...
    private static bool HasSameCtrlRamVersionDraft(
