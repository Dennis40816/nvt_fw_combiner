...
internal static partial class CompositionPlanningAdapter
{
        ...
        WorkbenchCtrlRamFirmwareVersionEdit? firmwareVersionEdit)
    {
        ...
        else
        {
            ...
            baseBytes = FirmwareInspectionAdapter.TryReadFirmwareImage(basePath);
            ...
            else
            {
                ...
                if (FirmwareInspectionAdapter.TryReadFirmwareConfigBackupMetadata(
                        icId,
                        baseBytes,
        ...
        else if (CanonicalCapabilityProjection.GetPostbuildProfiles(icId).Count == 0)
        {
            validationIssues.Add(new CompositionIssue(
        ...
        [
            .. sources.Select(source => CompositionMemoryProjection.CtrlRamSlotId(source.SourceId)),
        ];
        ...
        [
            .. sources
                .Where(source => slotPaths.TryGetValue(CompositionMemoryProjection.CtrlRamSlotId(source.SourceId), out string? path) &&
        ...
        if (firmwareVersionEdit is not null && baseBytes is not null && commandPlan is not null && FirmwareInspectionAdapter.TryReadFirmwareConfigBackupMetadata(icId, baseBytes, out FirmwareConfigMetadata backupMetadata) &&
        ...
        ActiveSessionSnapshot? acceptedSession = null)
    {
        return [
            ...
            .. context.SelectedSources
                .Select(source => CompositionMemoryProjection.CtrlRamSlotId(source.SourceId))
