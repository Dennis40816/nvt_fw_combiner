...
public static partial class CompositionAuthoringSessionAdapter
{
            ...
            CancellationToken cancellationToken)
    {
        ...
        GeneralAuthoringAdmissionResult admission = CanonicalAuthoringAdapter.AdmitGeneralMappingDraft(
            mappingDraft,
            referenceCapacity,
        ...
        if (!admission.IsAdmitted ||
            !CompositionPlanningAdapter.TryCreateGeneralReplaceMappings(
                admission,
                referenceCapacity,
        ...
        bool profileResolved = CompositionPlanningAdapter.TryResolvePostbuildProfile(
            icId,
        ...
        AuthoringSessionTransitionResult activated = session.Activate(CanonicalAuthoringAdapter.CreateGeneralExactCatalog(
            capability!,
        ...
        long observedLength)
    {
        ...
        ArgumentException.ThrowIfNullOrWhiteSpace(referencePath);
        ResolvedCapability? retained = CanonicalAuthoringAdapter.TryRetainGeneralMappingCompilation(
        ...
        if (!CanonicalAuthoringAdapter.TryCollectGeneralCandidateFileLengths(
                session,
                draft,
                mappingId,
                observedLength,
        ...
        GeneralAuthoringAdmissionResult admission = CanonicalAuthoringAdapter.AdmitGeneralMappingCandidate(
            draft,
            referenceCapacity,
            CanonicalAuthoringAdapter.CreateCurrentGeneralTrustedParentPolicy(
                registration.ExactParent.Admission.ParentBinding.ProfileId,
    ...
    {
        touchesTp = CompositionExecutionAdapter.GeneralReplaceTouchesTpRegion(regions, mappings);
        issue = null;
        if (!touchesTp)
        {
            return null;
        ...
        out IReadOnlyList<CompositionIssue> issues)
    {
        ...
        if (registration is null ||
            !CompositionPlanningAdapter.IsGeneralReplaceDpV2Route(selection, mappingDraft, regions, mappings))
        {
