...
{
    /// <summary>Creates one immutable execution intent without adding firmware semantics.</summary>
    public AcceptedCompositionExecutionRequest(
        ...
        CapabilityActionReadinessSnapshot? actionReadiness = null)
    {
        ...
        SlotPaths = new ReadOnlyDictionary<string, string>(
        ...
        AdditionalDeliveryOutputPath = additionalDeliveryOutputPath;
    ...
    public ActiveSessionSnapshot AcceptedSession { get; }

    /// <summary>Current host path hints matched against the accepted immutable input identities.</summary>
    public IReadOnlyDictionary<string, string> SlotPaths { get; }
    ...
    public string? AutomaticOutputDirectory { get; }
    ...
    public CapabilityActionReadinessSnapshot? ActionReadiness { get; }
}
