...
/// <summary>Stable authoring, planning, and report issue codes surfaced by typed clients.</summary>
public static class CompositionPlanningIssueCodes
{
    ...
    /// <summary>The selected IC is not an admitted General Merge logical-output member.</summary>
    public const string GeneralMergeMemberNotAdmitted =
    ...
    /// <summary>Replace mode is not recognized by the typed workflow router.</summary>
