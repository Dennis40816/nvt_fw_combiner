...
/// <summary>Owns parsed General Merge and General Replace mapping drafts.</summary>
public static class GeneralAuthoringMappingUseCase
{
    /// <summary>Parses one General Merge authoring row through the canonical mapping policy.</summary>
        ...
        FileStamp? acceptedFileStamp = null)
    {
        return AuthoringMappingState.Create(
            ...
            GeneralMergeIds.OutputRegionId,
            provenance,
            GeneralMappingFileRangePreset.SourceSlice);
    }

    /// <summary>Parses one General Replace authoring row through the canonical mapping policy.</summary>
    ...
    /// <summary>Creates one typed General Merge mapping draft.</summary>
    ...
    /// <summary>Creates one typed General Replace mapping draft.</summary>
    ...
    /// <summary>Validates parsed General Replace rows into one typed draft.</summary>
    public static bool TryCreateGeneralReplaceDraft(
        ...
        out IReadOnlyList<CompositionIssue> issues)
    {
        (string issueCode, string issueLabel) =
            expectedOperationKind == ExplicitMappingOperationKind.CopyRange
                ? (CompositionPlanningIssueCodes.GeneralMergeRangeInvalid, "General Merge mapping")
                : (CompositionPlanningIssueCodes.GeneralReplaceRangeInvalid, "General Replace mapping");
