...
{
    internal static bool IsAcceptedCtrlRamCapability(
    ...
    internal static bool TryResolveCtrlRamCapability(
        ...
        out IReadOnlyList<CompositionIssue> issues)
    {
        ...
        capability = resolution.Route!.BindCompilation(
                ...
                RuntimeReferenceCompilationProof.CreateLegacyPostbuild(
                    composition,
                    context.CommandPlan))
            .BindCtrlRamExecutionPlan(new AcceptedCtrlRamExecutionPlan(
                context.Selection,
                context.FirmwareVersionWritePlan is null
                    ? null
                    : context.FirmwareVersionDraft,
                context.AdvisoryIssues));
        issues = [];
        return true;
    }
        ...
        FirmwareArtifactPayload referencePayload)
    {
        ...
        [
            ...
            .. context.SelectedSources.Select(source => new V2ExplicitMappingInputBinding(
                DynamicCtrlRamReplacementIds.Create(source.SourceId),
                "ctrlram-source",
        ...
        [
            .. context.SelectedSources
                ...
                .Select((entry, index) =>
                {
                    ...
                    DynamicCtrlRamReplacementIds.Create(entry.Source.SourceId),
        ...
        V2RuntimeReferenceReplacePostbuildPolicy? postbuildPolicy =
            diffDlmPolicy is null
                ...
                : new V2RuntimeReferenceReplacePostbuildPolicy(
                    ...
                    diffDlmSource is null ? null : DynamicCtrlRamReplacementIds.Create(diffDlmSource.SourceId),
