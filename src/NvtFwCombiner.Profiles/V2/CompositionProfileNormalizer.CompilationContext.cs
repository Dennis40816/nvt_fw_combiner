...
internal static partial class CompositionProfileNormalizer
{
    ...
    {
        if (document.SchemaVersion is not ("2.4" or "2.5" or "2.6" or "2.7" or "2.8" or "2.9" or "2.10" or "2.11" or "2.12"))
        {
            return document.CompilationContext is not null || document.LogicalOutputBinding is not null
                ? throw Error("compilationContext", "Compilation contexts require composition-profile schema version '2.4' through '2.12'.")
        ...
        return context.Kind switch
        {
            ...
            "runtime-reference-replace" when
                (document.SchemaVersion is "2.6" or "2.7" or "2.8" or "2.9" or "2.10" or "2.11" or "2.12") && document.LogicalOutputBinding is null =>
            ...
            "runtime-reference-replace" when document.SchemaVersion is not "2.6" and not "2.7" and not "2.8" and not "2.9" and not "2.10" and not "2.11" and not "2.12" => throw Error(
                "compilationContext.kind",
                "The runtime-reference-replace context requires composition-profile schema version '2.6' through '2.12'."),
