...
internal static partial class CompositionProfileNormalizer
{
    ...
    {
        if (document.SchemaVersion is not ("2.4" or "2.5" or "2.6" or "2.7" or "2.8"))
        {
            return document.CompilationContext is not null || document.LogicalOutputBinding is not null
                ? throw Error("compilationContext", "Compilation contexts require composition-profile schema version '2.4', '2.5', '2.6', '2.7', or '2.8'.")
        ...
        return context.Kind switch
        {
            ...
            "runtime-reference-replace" when
                (document.SchemaVersion is "2.6" or "2.7" or "2.8") && document.LogicalOutputBinding is null =>
            ...
            "runtime-reference-replace" when document.SchemaVersion is not "2.6" and not "2.7" and not "2.8" => throw Error(
                "compilationContext.kind",
                "The runtime-reference-replace context requires composition-profile schema version '2.6', '2.7', or '2.8'."),
