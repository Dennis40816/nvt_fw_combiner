...
internal static partial class CompositionProfileValueRules
{
        ...
        string parameterName)
    {
        return schemaVersion switch
        {
            ...
            "2.2" or "2.3" or "2.4" or "2.5" or "2.6" or "2.7" or "2.8" or "2.9" or "2.10" => RequireExternalToolBindingId(value, parameterName),
    ...
    internal static string RequireLegacyCombinerInvocationProfileIdForSchemaVersion(
        ...
        string parameterName)
    {
        if (schemaVersion is not "2.7" and not "2.8" and not "2.9" and not "2.10")
        {
        ...
        string parameterName)
    {
        return schemaVersion switch
        {
            ...
            "2.5" or "2.6" or "2.7" or "2.8" or "2.9" or "2.10" => SnapshotIds(values, parameterName, requireValue: true, RequireIcId),
