...
/// <summary>Bounded report-detail window that materializes more UI rows only on request.</summary>
public sealed class ReportPagedListViewModel : ObservableObject
{
    ...
    /// <summary>Total rows available in the complete report projection.</summary>
    public int TotalCount => _allItems.Count;

    /// <summary>Rows currently materialized for controls.</summary>
