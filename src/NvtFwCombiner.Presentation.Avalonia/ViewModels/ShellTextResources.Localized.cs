...
internal sealed partial class ShellTextResources
{
    private static ShellTextResources CreateLocalized(ShellLanguage language)
    {
        ...
        return new ShellTextResources
        {
            ...
            LocalStateSaveFailedTitle = Pick("Recent work not saved", "最近的工作未儲存"),
            LocalStateSaveFailedDetailFormat = Pick(
                "Couldn't save your recent work state: {0}. Your current work isn't affected.",
                "無法儲存最近的工作狀態：{0}。目前的工作不受影響。"),
            LocalStateSaveAccessDeniedReason = Pick("access denied", "存取遭拒"),
            LocalStateSaveStorageFullReason = Pick("the disk is full", "磁碟空間不足"),
