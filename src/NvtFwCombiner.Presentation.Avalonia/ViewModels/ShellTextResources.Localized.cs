    ...
    private static ShellTextResources CreateLocalized(ShellLanguage language)
    {
        ...
        return new ShellTextResources
        {
            ...
            OutputDeliverySummary = Pick(
                "Confirm the output options before Build.",
                "建立前請確認輸出選項。"),
            OutputDeliveryBundleLabel = Pick(
                "Deliver output and sources in one bundle folder",
                "將輸出與來源放入同一個 bundle 資料夾"),
            ...
            OutputDeliveryOutputLabel = Pick("Output filename", "輸出檔名"),
            ...
            OutputDeliveryResolvedLabel = Pick("Resolved destination", "實際輸出位置"),
