...
public sealed partial class ShellTextResources
{
    private static ShellTextResources CreateLocalized(ShellLanguage language)
    {
        ...
        return new ShellTextResources
        {
            ...
            HexDiffNoSelectionDetail = Pick("Select a changed range to review its reason and evidence.", "選取變更區段，以檢視修改原因與證據。"),
            ...
            HexDiffDocumentScrollBarAutomationName = Pick("Scroll complete output BIN", "捲動完整輸出 BIN"),
