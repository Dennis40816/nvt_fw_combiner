...
internal sealed partial class ShellTextResources
{
    private static ShellTextResources CreateLocalized(ShellLanguage language)
    {
        ...
        return new ShellTextResources
        {
            ...
            CtrlRamReferenceFormatLabel = Pick("Reference format", "Reference 格式"),
            CtrlRamStandardReferenceLabel = Pick("Standard", "標準"),
            CtrlRamAbReferenceLabel = Pick("AB Reference", "AB Reference"),
