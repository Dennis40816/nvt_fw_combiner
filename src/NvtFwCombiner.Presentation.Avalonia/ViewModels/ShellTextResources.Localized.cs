...
public sealed partial class ShellTextResources
{
    private static ShellTextResources CreateLocalized(ShellLanguage language)
    {
        ...
        return new ShellTextResources
        {
            ...
            HexDiffAddressLabel = Pick("Address", "位址"),
            HexDiffOutputBytesLabel = Pick("Output bytes", "輸出 bytes"),
            HexDiffAsciiLabel = "ASCII",
            HexDiffChangedRowLabel = Pick("Changed", "已變更"),
            HexDiffReferenceRowLabel = Pick("Original", "原始內容"),
            HexDiffShowOriginalRowsLabel = Pick("Show original rows for changes", "在變更列下方顯示原始內容"),
            HexDiffJumpAddressLabel = Pick("Jump to output address", "跳至輸出位址"),
            HexDiffJumpActionLabel = Pick("Jump", "跳轉"),
            HexDiffChangeInformationTitle = Pick("Change information", "變更資訊"),
            HexDiffNoSelectionDetail = Pick("Jump to or select a reported range to review its reason and evidence.", "跳至或選取已報告區段，以檢視修改原因與證據。"),
            HexDiffRangeNavigatorTitle = Pick("Changed ranges", "變更區段"),
            HexDiffRangeNavigatorDetail = Pick("Review-required ranges appear first; all ranges use half-open output offsets.", "待審查區段優先顯示；所有區段均使用輸出空間的半開位址。"),
            HexDiffResizeAutomationName = Pick("Resize Hex Diff and change information panels", "調整 Hex Diff 與變更資訊面板寬度"),
            HexDiffBeforeSha256Label = Pick("Before SHA-256", "變更前 SHA-256"),
            HexDiffAfterSha256Label = Pick("After SHA-256", "變更後 SHA-256"),
            HexDiffSelectedRangeLabel = Pick("Selected", "已選取"),
