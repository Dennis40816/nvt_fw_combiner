...
internal sealed partial class ShellTextResources
{
    private static ShellTextResources CreateLocalized(ShellLanguage language)
    {
        ...
        return new ShellTextResources
        {
            ...
            SettingsOverviewSubtitle = Pick("Installed version and authoring profile coverage.", "已安裝版本與 authoring profile coverage。"),
            SettingsCapabilitiesTitle = Pick("Implemented capabilities", "已實作功能"),
            SettingsCapabilitiesSubtitle = Pick("Canonical authoring availability with independent execution and evidence disclosure.", "Canonical authoring availability，以及獨立的 execution 與 evidence 資訊。"),
            ...
            ReducedMotionDescription = Pick(
                ...
                "保留步驟狀態，同時停用非必要的進度動畫。"),
            SupportMatrixOpenLabel = Pick("Open Support Matrix", "開啟支援矩陣"),
            SupportMatrixTitle = Pick("Support Matrix", "支援矩陣"),
            SupportMatrixSubtitle = Pick(
                "Read-only capability, publication, and evidence disclosure from the current canonical catalog.",
                "來自目前 canonical catalog 的唯讀 capability、publication 與 evidence 資訊。"),
            SupportMatrixBackLabel = Pick("Back to Settings", "返回設定"),
            SupportMatrixIcLabel = "IC",
            SupportMatrixWorkflowLabel = "Workflow",
            SupportMatrixIcCountLabel = "IC Count",
            SupportMatrixMapVariantLabel = Pick("Map variant", "Map variant"),
            SupportMatrixAuthoringLabel = "Authoring",
            SupportMatrixExecutionLabel = "Execution",
            SupportMatrixPublicationLabel = "Publication",
            SupportMatrixEvidenceLabel = "Evidence",
            SupportMatrixBlockerLabel = Pick("Blocker", "阻擋原因"),
            SupportMatrixCatalogVersionLabel = Pick("Catalog version:", "Catalog 版本："),
            SupportMatrixSourceHashLabel = Pick("Source SHA-256:", "來源 SHA-256："),
            SupportMatrixResolutionTokenLabel = Pick("Publication token:", "Publication token："),
            SupportMatrixFingerprintLabel = "Capability fingerprint",
            SupportMatrixNoBlockerLabel = Pick("Clear", "無阻擋"),
            SupportMatrixLegendTitle = Pick("Evidence status", "Evidence 狀態"),
            SupportMatrixReviewedEvidenceLabel = Pick("Reviewed evidence", "已審核 evidence"),
            SupportMatrixContractOnlyLabel = Pick("Contract only", "僅有 contract"),
            SupportMatrixReviewRequiredLabel = Pick("Review required", "需要審查"),
            SupportMatrixBlockedLabel = Pick("Blocked", "已阻擋"),
            SupportMatrixNotDeclaredLabel = Pick("Not declared", "未宣告"),
            SupportMatrixHoverHint = Pick(
                "Hover or focus a cell for exact route details; Escape closes the card.",
                "將滑鼠移到交叉格或以鍵盤聚焦即可查看 exact route 明細；Escape 可關閉。"),
