...
- Owner decision on 2026-07-22 supersedes the earlier visibility schedule: the repository remains Public through the stable `v1.0.0` release and becomes Private afterward. Public history, caches, and existing forks cannot be retracted by the later transition; the release inventory therefore continues to exclude firmware payloads, secrets, private goldens, and owner-handoff archives.
