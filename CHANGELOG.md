...
- Verification: UI smoke tests cover 325 cases including AB readiness, hidden AB cache clearing, semantic slot severity, Changed/Kept pattern transitions and legend bindings, exact 300-unit normalization, pointer pass-through, focus-tooltip selection lifecycle, modal hit testing, and expanded action-rail spacing contracts. IC evidence now names verified/open workflows instead of presenting workflow counts as golden-case counts.
