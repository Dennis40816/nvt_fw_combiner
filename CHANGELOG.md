...
- The exact integration tree contains 59,995 nonblank production C#/AXAML lines under the owner-approved hard maximum of 60,000; code size is a maintainability gate, not the release performance KPI.
