...
- The exact review-fix tree contains 60,042 nonblank production C#/AXAML lines under the owner-approved temporary maximum of 60,100; the 42-line increase above the earlier ceiling retains same-path firmware identity and final save-dialog revalidation. Code size is a maintainability gate, not the release performance KPI.
