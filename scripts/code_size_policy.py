...
DEFAULT_LIMITS = CodeSizeLimits(
    ...
    runtime_production_allowance=28_834,
    domain_profiles_allowance=5,
    application_allowance=11_832,
    bootstrap_cli_allowance=1_661,
    infrastructure_contracts_worker_allowance=15_341,
    full_production_allowance=35_086,
)
