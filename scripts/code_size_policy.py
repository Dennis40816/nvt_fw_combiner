...
DEFAULT_LIMITS = CodeSizeLimits(
    ...
    runtime_production_allowance=5_216,
    application_allowance=2_783,
    bootstrap_cli_allowance=111,
    infrastructure_contracts_worker_allowance=2_322,
    full_production_allowance=7_663,
)
