...
DEFAULT_LIMITS = CodeSizeLimits(
    ...
    runtime_production_allowance=29_529,
    domain_profiles_allowance=130,
    application_allowance=12_314,
    bootstrap_cli_allowance=1_661,
    infrastructure_contracts_worker_allowance=15_429,
    full_production_allowance=37_614,
)
