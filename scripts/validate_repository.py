...
REQUIRED_FILES = {
    ...
    "docs/contracts/composition-request-v1.schema.json", "docs/contracts/composition-report-v1.schema.json",
    "docs/contracts/candidate-workspace-v1.md", "docs/contracts/candidate-workspace-v1.schema.json",
