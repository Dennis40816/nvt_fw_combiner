...
2. Define canonical regions once, including typed `owner`, `kind`, protection,
   and semantic classification. CtrlRAM eligibility comes from physical
   `owner = tp`, `kind = ctrlram` facts, not a UI label.
